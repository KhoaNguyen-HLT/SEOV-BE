...
""", nativeQuery = true)
    ...
    SELECT
            ...
            TO_CHAR(A.created_at, 'YYYY-MM-DD HH24:MI') as createAt,
            TO_CHAR(A.updated_at, 'YYYY-MM-DD HH24:MI') as updatedAt,
            TO_CHAR(A.request_need_date, 'YYYY-MM-DD HH24:MI') AS requestNeedDate,
            TO_CHAR(A.required_time, 'HH24:MI') as requiredTime,
